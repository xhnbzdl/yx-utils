...
namespace Yx.Utils.Helper
{
    ...
    {
        /// <summary>
        /// 检查givenType给定类型是否实现/继承泛型genericType类型
        /// </summary>
        /// <param name="givenType">检查的类型</param>
        /// <param name="genericType">目标泛型</param>
        ...
        /// </summary>
        /// <param name="inherit">是否检查从基类继承的属性</param>
        ...
        /// <summary>
        /// 获取类型和成员上指定的Attribute
        /// </summary>
        /// <typeparam name="TAttribute">指定的Attribute</typeparam>
        /// <param name="memberInfo">成员</param>
        /// <param name="type">类型</param>
        /// <param name="inherit">是否检查继承得来的</param>
